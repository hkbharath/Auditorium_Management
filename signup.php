	...
	<div id="main">
		...
		<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" >
			...
			<fieldset>
				...
				<p><input type="text" id="name" placeholder="Your Complete Name" name="name" required="required"></p>
				
				<p><label for="email">Username</label></p>
				<p><input type="text" id="uname" placeholder="Your Handle" name="handle" required="required"></p>  
				
				<p><label for="email">E-mail address</label></p>
				<p><input type="email" id="email" placeholder="Your Email" name="email" required="required"></p> 
				...
				<p><input type="password" id="repassword" placeholder="Your Password" name="repass" required="required"></p>
